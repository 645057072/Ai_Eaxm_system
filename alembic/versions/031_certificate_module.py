...
def upgrade() -> None:
    ...
    op.create_index("ix_exam_cert_template_enterprise_id", "exam_cert_template", ["enterprise_id"])
    op.create_index("ix_exam_cert_template_course_id", "exam_cert_template", ["course_id"])
    op.create_index("ix_exam_cert_template_status", "exam_cert_template", ["status"])
    ...
    op.create_index("ix_exam_cert_record_enterprise_id", "exam_cert_record", ["enterprise_id"])
    op.create_index("ix_exam_cert_record_cert_template_id", "exam_cert_record", ["cert_template_id"])
    op.create_index("ix_exam_cert_record_user_id", "exam_cert_record", ["user_id"])
    op.create_index("ix_exam_cert_record_exam_service_record_id", "exam_cert_record", ["exam_service_record_id"])
