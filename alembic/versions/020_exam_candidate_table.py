...
def upgrade() -> None:
    ...
    op.create_index("ix_exam_candidate_exam_no", "exam_candidate", ["exam_no"], unique=False)
    op.create_index("ix_exam_candidate_enterprise_id", "exam_candidate", ["enterprise_id"], unique=False)
    op.create_index("ix_exam_candidate_course_id", "exam_candidate", ["course_id"], unique=False)
    op.create_index("ix_exam_candidate_student_id", "exam_candidate", ["student_id"], unique=False)
