...
def upgrade() -> None:
    ...
    op.create_index("ix_student_student_no", "student", ["student_no"], unique=False)
    op.create_index("ix_student_full_name", "student", ["full_name"], unique=False)
    op.create_index("ix_student_company_name", "student", ["company_name"], unique=False)
    op.create_index("ix_student_enterprise_id", "student", ["enterprise_id"], unique=False)
    op.create_index("ix_student_created_by", "student", ["created_by"], unique=False)
